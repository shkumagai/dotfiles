...
# path_helper reorders PATH each time it runs, so children shells skip the rest of this block.
# This is a workaround for the issue that path_helper is not idempotent.
